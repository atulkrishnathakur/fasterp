"""Initial sales country migration

Revision ID: 209e673bc829
Revises: d33968e60db6
Create Date: 2024-10-30 09:27:57.389557
...
revision: str = '209e673bc829'
down_revision: Union[str, None] = 'd33968e60db6'
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('countries', schema='sales')
    # ### end Alembic commands ###
