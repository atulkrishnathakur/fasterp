...
4. Comment the all code of upgrade() and downgrade() funciton and use the pass keyword
```
def upgrade() -> None:
...
8. create migration to creatte new table 
...
```
9. create its model file for account table
